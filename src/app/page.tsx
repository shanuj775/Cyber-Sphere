    ...
    <div className="flex flex-col gap-0 overflow-x-hidden">
        ...
        <div className="flex animate-marquee gap-20">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex gap-20 items-center">
              <span className="text-white text-xs font-bold uppercase tracking-[0.3em]">{t('home.ticker.scans')}: 12.8M+</span>
              <span className="text-white/40 text-xs">•</span>
              <span className="text-white text-xs font-bold uppercase tracking-[0.3em]">{t('home.ticker.threats')}: 4.2M</span>
              <span className="text-white/40 text-xs">•</span>
              <span className="text-white text-xs font-bold uppercase tracking-[0.3em]">{t('home.ticker.uptime')}: 99.999%</span>
              <span className="text-white/40 text-xs">•</span>
              <span className="text-white text-xs font-bold uppercase tracking-[0.3em]">{t('home.ticker.nodes')}: 2,400</span>
              <span className="text-white/40 text-xs">•</span>
            </div>
          ))}
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-32 w-full grid md:grid-cols-12 gap-12">
        <div className="md:col-span-4 space-y-6">
          ...
          <h2 className="text-3xl font-headline font-bold">{t('home.intel.title')}</h2>
      ...
      <section className="bg-secondary/30 py-32">
        <div className="max-w-7xl mx-auto px-6 flex flex-col items-center text-center space-y-12">
          <div className="space-y-4">
            <Badge className="bg-primary/10 text-primary border-primary/20 rounded-full px-4 py-1 text-[10px] font-bold uppercase tracking-widest">{t('home.sdg.badge')}</Badge>
            <h2 className="text-4xl md:text-5xl font-headline font-bold">{t('home.sdg.title')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
            {[
              { icon: <Scale />, title: t('home.sdg.item1.title'), desc: t('home.sdg.item1.desc') },
              { icon: <Gavel />, title: t('home.sdg.item2.title'), desc: t('home.sdg.item2.desc') },
              { icon: <Handshake />, title: t('home.sdg.item3.title'), desc: t('home.sdg.item3.desc') },
            ].map((item, i) => (
      ...
      <section className="max-w-7xl mx-auto px-6 py-32 w-full">
        <div className="grid md:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            <h2 className="text-4xl font-headline font-bold">{t('home.tech.title')}</h2>
